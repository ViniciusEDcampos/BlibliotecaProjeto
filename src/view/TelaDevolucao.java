...
public class TelaDevolucao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConfirmaDevolucao = new javax.swing.JButton();
        txtDataDevolucaoCliente = new javax.swing.JTextField();
        ...
        btnConfirmaDevolucao.setBackground(new java.awt.Color(159, 199, 170));
        btnConfirmaDevolucao.setFont(new java.awt.Font("Georgia", 1, 12)); // NOI18N
        btnConfirmaDevolucao.setText("Confirmar devolução");
        btnConfirmaDevolucao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnConfirmaDevolucaoActionPerformed(evt);
            }
        });

        txtDataDevolucaoCliente.setBackground(new java.awt.Color(240, 240, 234));
        ...
        jLabel1.setText("Realizar Devolução");
        ...
        jToggleButton1.setText("Tela de Emprestimo");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtDataDevolucaoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(34, 34, 34)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnConfirmaDevolucao, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(limpar, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel2)
                    .addComponent(btnConfirmaDevolucao, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(txtDataDevolucaoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnConfirmaDevolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmaDevolucaoActionPerformed
    ...
    }//GEN-LAST:event_btnConfirmaDevolucaoActionPerformed
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        // TODO add your handling code here:
        RealizarEmprestimo livrosEmprestimo = new RealizarEmprestimo();
        livrosEmprestimo.setVisible(true);
        this.dispose();
    ...
    private javax.swing.JButton btnConfirmaDevolucao;
    ...
    private javax.swing.JTextField txtDataDevolucaoCliente;
    ...
    private boolean verificarDados() {
        if (!txtDataDevolucaoCliente.getText().isEmpty()
   ...
   private void limpar() {
    txtDataDevolucaoCliente.setText("");
    cxbCliente.setSelectedIndex(0); 
    cxbLivro.setSelectedIndex(0);   
    cxbCliente.requestFocus();
}

  private void cadastrarDevolucao() throws SQLException {
    ...
    String dataDevolucaoCliente = txtDataDevolucaoCliente.getText();
    if (dataDevolucaoCliente == null || dataDevolucaoCliente.trim().isEmpty()) {
        JOptionPane.showMessageDialog(this, "Informe a data de devolução do cliente.");
        return;
    }

      daoEmprestimo crud = new daoEmprestimo();

    // Busca o id do empréstimo aberto
    int idEmprestimo = crud.buscarIdEmprestimoAberto(usuarioSelecionado.getCPF(), livroSelecionado.getIsbn());

    // Registra a devolução passando o idEmprestimo
    crud.registrarDevolucao(idEmprestimo, dataDevolucaoCliente);
    ...
    private void carregarComboBoxes() {
        ...
        try {
            ...
            for (Livros l : crud.listarLivrosEmprestados()) {
                comboLivros.addItem(l);
            }
       } catch (SQLException ex) {
    ex.printStackTrace(); // mostra no console o erro real
    JOptionPane.showMessageDialog(null, "Erro real: " + ex.getMessage(), "Erro ao salvar", JOptionPane.ERROR_MESSAGE);
}
    }
   ...
   private void atualizarLivros() throws SQLException {
    ...
    if (livroSelecionado != null) {
        if (livroSelecionado.getIsbn() != null && !livroSelecionado.getIsbn().isEmpty()) {
            livroSelecionado.setDisponibilidade("s");
            ...
            JOptionPane.showMessageDialog(null, "Erro: ISBN inválido.");
        }
    } else {
        JOptionPane.showMessageDialog(null, "Erro: Nenhum livro selecionado.");
    }
}
}
